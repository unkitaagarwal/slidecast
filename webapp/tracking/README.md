...
3. Fill in:
   - **App name**: `RecipeVault Studio Tracking` (or anything)
...
- **Sandbox → Add test user** for each of:
   `nutrilens.ai`, `myrecipefolder`, `recipehackswithsusan`, `RecipeVaultApp`,
   `recipevault.app`, `recipediahealthy`, `recipehackdaily`, `thekitchenfolder`,
