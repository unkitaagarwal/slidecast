...
Mirrors pipeline/postiz_publish.py but:
  ...
  - Includes #Slidecast and curated viral hashtags
...
def build_caption(comp: dict) -> str:
    """Short clean caption — hook + Slidecast CTA + hashtags. No recipe dump."""
    ...
    lines = [
        ...
        "",
        "Made with Slidecast — generate carousels & auto-post to all your accounts. Link in bio \U0001f4dd\U0001f373",
        "",
        hashtags,
    ]
    return "\n".join(lines)
