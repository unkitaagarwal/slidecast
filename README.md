# RecipeVault Carousel Engine

A self-contained system for generating TikTok / Instagram recipe carousels
end-to-end: theme brief → Gemini text + image generation → composited PNG
slides → Postiz multi-account scheduling → owned-account performance tracking.
